...
package com.example.assignmentenrique.widget;
...
public class CustomTitleView extends RelativeLayout implements TitleViewAdapter.Provider {
    ...
    public CustomTitleView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mSubtitleTextView = root.findViewById(R.id.subtitle_tv);
        mSearchOrbView = root.findViewById(R.id.search_orb_view);
        mSearchOrbView.setOrbColor(getResources().getColor(R.color.skyblue));
    }
